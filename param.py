...
def process_args():
    ...
    parser.add_argument('--config', is_config_file=True, help='Config file path')  # 这个is_config_file，允许一次加载整个文件内的config？

    # Datasets
    parser.add_argument(
        "--dataset_name",
        type=str,
        default='../MSG-master/bert_data/static_10000',
